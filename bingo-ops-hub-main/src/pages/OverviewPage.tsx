  ...
  return (
    <div className="space-y-4 md:space-y-6">
      <div>
        ...
        <p className="text-xs md:text-sm text-muted-foreground">Real-time platform monitoring</p>
      </div>
      ...
      <div className="grid grid-cols-1 gap-4 lg:gap-6 lg:grid-cols-2">
        ...
        <div className="glass-card p-4 md:p-5">
          <h3 className="mb-3 md:mb-4 text-xs md:text-sm font-semibold uppercase tracking-wider text-muted-foreground">
            ...
            <div className="min-w-[300px]">
              <ResponsiveContainer width="100%" height={220} className="md:h-[260px]">
                <AreaChart data={charts?.revenue || []}>
                  ...
                  <YAxis tick={{ fill: "hsl(215 14% 50%)", fontSize: 11 }} axisLine={false} tickLine={false} tickFormatter={(v) => `${(v / 1000).toFixed(0)}k`} />
                  <Tooltip
